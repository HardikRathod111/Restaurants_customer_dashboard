...
const [adminData, setAdminData] = useState({});
  ...
  const acceptOrderHandler = async (orderId) => {
    ...
    try {
      const response = await fetch(`https://restaurants-customer-dashboard.vercel.app/api/v1/order/accept-order/${orderId}`, {
  ...
  const [orders, setOrders] = useState([]);
    const fetchOrders = async () => {
      try {
        const response = await fetch("https://restaurants-customer-dashboard.vercel.app/api/v1/order/getPlacedOrder");
