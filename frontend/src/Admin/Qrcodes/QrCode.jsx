...
function QrCode() {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(`https://restaurants-customer-dashboard.vercel.app/api/v1/qrCode/deleteQrCode/${selectedQrCodeId}`, {
        method: 'DELETE',
      });
  ...
  useEffect(() => {
      const fetchQrCodes = async () => {
          try {
              const response = await axios.get('https://restaurants-customer-dashboard.vercel.app/api/v1/qrCode/getAllQrCodes');
